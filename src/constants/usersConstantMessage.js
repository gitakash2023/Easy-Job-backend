const userConstantMessages = {
    ...
    USER_REGISTERED_FAIL: "User registered fail.",
    ...
    OTP_SENT:"Otp is sent in your registered Number.",
    OTP_SENT_FAIL:"Fail to sent the otp.",
    ...
    OTP_VERIFY_SUCCESSFULLY:"Otp Verify Successffully.",
    OTP_VERIFY_FAIL:"Otp Verify Fail.",
    YOU_HAVE_ENTER_WRONG_OTP:"You have enter wrong OTP",
    MOBILE_NUMBER_ALREADY_EXIST:"This Mobile number already exist",
    USER_NOT_FOUND:"User Not found",
    YOUR_DETAILS_IS_HERE:"Your details is here"
  };
